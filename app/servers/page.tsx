...
import { 
  ...
  Activity, ArrowLeft, ChevronRight, LayoutGrid, List
} from 'lucide-react';
...
export default function ServersPage() {
  ...
  // Servidores de ejemplo (Esto luego vendrá de tu API/DB)
  const servers = [
    { id: 1, name: "Hypixel Network", ip: "mc.hypixel.net", players: "42,103", version: "1.8 - 1.20", status: "online", type: "Minigames" },
    { id: 2, name: "Wynncraft", ip: "play.wynncraft.com", players: "1,245", version: "1.20.1", status: "online", type: "MMORPG" },
    { id: 3, name: "Mineplex", ip: "us.mineplex.com", players: "0", version: "1.8", status: "offline", type: "Classic" },
  ];
      ...
      <nav className="border-b border-white/5 backdrop-blur-md bg-[#1a1d23]/80 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">12,432 Servers Monitored</span>
          </div>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          <div className="relative flex-1 group">
            ...
            <input 
              type="text" 
              placeholder="Search servers by name, IP or version..."
        ...
        <div className="flex gap-3 overflow-x-auto pb-6 no-scrollbar">
          {['All Servers', 'Survival', 'Skyblock', 'Minigames', 'Factions', 'Creative', 'Anarchy'].map((cat) => (
    ...
    >
      ...
      <div className="flex-1 text-center md:text-left">
        <div className="flex flex-col md:flex-row md:items-center gap-2 mb-1">
          ...
          <span className="text-[10px] font-black px-2 py-0.5 rounded bg-white/5 text-gray-500 uppercase w-fit mx-auto md:mx-0">
            {server.type}
          </span>
        </div>
      ...
      <div className="flex gap-8 px-8 border-x border-white/5 hidden lg:flex">
        <div className="text-center">
          ...
          <div className="flex items-center gap-2 justify-center">
            ...
            <span className="font-black text-sm">{server.players}</span>
          </div>
        </div>
        <div className="text-center">
          <p className="text-[9px] font-black text-gray-500 uppercase tracking-widest mb-1">Version</p>
          <span className="font-black text-sm">{server.version}</span>
        </div>
      </div>
